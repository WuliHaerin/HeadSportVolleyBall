...
{
    public GameObject pauseMenu, gameOverMenu, inGameButton,adPanel;
    ...
    public IEnumerator SetGameUnActive()
    {
        ...
        if(!isContinue)
        {
            ...
            gameOverMenu.transform.GetChild(0).GetChild(5).GetComponent<TMP_Text>().text = p1Name.text;
            ...
            gameOverMenu.transform.GetChild(1).GetChild(5).GetComponent<TMP_Text>().text = p2Name.text;
